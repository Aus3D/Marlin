...
#ifndef _HAL_TIMERS_STM32_H
#define _HAL_TIMERS_STM32_H
...
#define HAL_TIMER_RATE         (HAL_RCC_GetSysClockFreq()/2)  // frequency of timers peripherals
